...
@Component({
  ...
  selector: 'app-add-mc',
  templateUrl: './add-mc.page.html',
  styleUrls: ['./add-mc.page.scss', '../../setup.page.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class AddMcPage implements OnInit {
  responsemsg: any;
  ...
  doSubmit(): void {
    ...
    this.unsubscribe$.sink = this._setupapiservuce.addMc(this.submitForm.value).subscribe(data => {
      ...
      if (this.apiresponse.message === 'ERROR') {
        ...
        this._loadingservice.routeAfter(600, `/app/settings/list-mc/${this._authservice.center.id}`, 'MC Added Successfylly', 'middle', false, '');
      }
